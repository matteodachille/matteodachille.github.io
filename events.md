...
24/06/2021 - 1st convention of **SIFS**, Parma, IT, [link](http://www.fisicastatistica.unipr.it/conf/PARMA2021/welcome.php){:target="_blank"}, 10 min (Poster session, Room 4)
{: style="font-size: 20px" }

_Consequences of Weyl's law in low-dimensional Euclidean Random Assignment Problems_, ([slides <i class="fa fa-file-pdf-o" aria-hidden="true"></i>](#))
{: style="margin-left: 40px" }
